...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS17Random',
)
...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS13Random',
)
...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS13',
)
...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS11',
)
...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS9',
)
...
register(
    ...
    entry_point='gym.envs.minigrid.envs:MemoryS7',
)
